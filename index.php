...
<body>
    <header>
        <div class="content">
            <div class="top">
                <div class="left">
                    <img src="img/purepng.com-google-logo-2015brandlogobrand-logoiconssymbolslogosgoogle-6815229372333mqrr.webp" alt="">
            ...
            <div class="bottom">
                <nav>
                    <ul>
                        ...
                        <li class="bar"><a class="selected" href="#">Domande frequenti</a></li>
                    </ul>
                </nav>
            </div>
        </div>
    ...
    <main>
        <div class="container">
            <?php foreach($data as $info) { ?>
                <h2><?php echo $info['domande'] ?></h2>
                <?php echo $info['risposte'] ?>
                <?php } ?>
        </div>
    </main>
